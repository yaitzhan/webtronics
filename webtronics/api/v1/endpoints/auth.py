...
from webtronics.integrations.clearbit.tasks import update_user_clearbit_data
from webtronics.integrations.emailhunt.tasks import update_user_email_hunt_data
...
async def sign_up(
    ...
    if not user:
        ...
        background_tasks.add_task(update_user_email_hunt_data, db, user_id=user.id, user_email=user_in.email)
        return user
